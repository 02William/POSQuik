 ...
 */
public class QuotationDetails extends javax.swing.JFrame {
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        ...
        try {
            GeneratePDF.createQuotationPDF(model,customer,address,vat,tel,email, pdfTotal, pdfNoVatTotal, pdfDiscount); // Create the PDF with GeneratePDF class
        } catch (SQLException ex) {
            Logger.getLogger(InvoiceDetails.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        JOptionPane.showMessageDialog(null, "Pdf Successfully Generated.", "Quotation", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuotationDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new QuotationDetails().setVisible(true);
        });
    }
